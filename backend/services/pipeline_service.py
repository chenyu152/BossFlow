...
def _item_from_line(line: str, status: str) -> dict[str, Any] | None:
    ...
    return {
        ...
        "scoringVersion": meta.get("scoringVersion"),
        "fitLevel": meta.get("fitLevel", ""),
        "coverage": meta.get("coverage"),
        "jdQuality": meta.get("jdQuality"),
        "salarySignal": meta.get("salarySignal"),
        "salaryRisk": meta.get("salaryRisk"),
        "salaryMatch": meta.get("salaryMatch"),
        "keywordCoverage": meta.get("keywordCoverage"),
        ...
        "reasonCodes": meta.get("reasonCodes") or [],
