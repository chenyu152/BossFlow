...
export const JOB_DIRECTION_TEMPLATES: JobDirectionTemplate[] = [
  ...
  },
  {
    ...
    scoringKeywords: ['需求分析', '产品规划', '数据分析', '用户研究', '原型设计', 'AI 产品'],
  },
  {
    ...
    scoringKeywords: ['TypeScript', 'JavaScript', 'React', 'Vue', 'CSS', '前端工程化'],
  },
  {
    ...
    scoringKeywords: ['Java', 'Python', 'Go', '微服务', 'MySQL', 'Redis', '分布式系统'],
  },
  {
    ...
    scoringKeywords: ['SQL', 'Python', '数据分析', '机器学习', 'BI', '统计分析'],
  },
  {
    ...
    scoringKeywords: ['C/C++', 'STM32', 'FreeRTOS', 'Linux', '嵌入式系统', '通信协议'],
  },
];
...
export function buildTemplateSeed(template: JobDirectionTemplate | undefined, name: string, citiesText: string): ProjectTemplateSeed {
  ...
  return {
    ...
    relevanceText: [...new Set([...keywords, ...scoringKeywords])].join('\n'),
    blacklistText: '',
    scoringKeywords,
  };
}
